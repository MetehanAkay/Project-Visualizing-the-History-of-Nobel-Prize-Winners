...
plt.title('Proportion of USA Born Nobel Winners')  # Set the title
plt.show()  # Display the plot
plt.close()  # Clear the plot from memory
...
plt.title('Proportion of Female Nobel Winners')  # Set the title
plt.show()  # Display the plot
plt.close()  # Clear the plot from memory
